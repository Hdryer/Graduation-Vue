        ...
        <el-form ref="form" :model="formData"  label-width="120px">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="A" prop="optionA" >
                            <el-input v-model="formData.optionA" @click="showPanel2=true"/>
                            <el-dialog  v-model="showPanel2" >
                                <v-md-editor  height="300px" v-model="formData.optionA" />
                                <template #footer>
                                      <span class="dialog-footer">
                                        <el-button type="primary" @click="showPanel2 = false">确认</el-button>
                                        <el-button @click="showPanel2 = false">取消</el-button>
                                      </span>
                                </template>
                            </el-dialog>
                        </el-form-item>
                    ...
                    <el-col :span="12">
                        <el-form-item label="B" prop="optionB">
                            <el-input v-model="formData.optionB" @click="showPanel3=true"/>
                            <el-dialog  v-model="showPanel3" >
                                <v-md-editor  height="300px" v-model="formData.optionB" />
                                <template #footer>
                                      <span class="dialog-footer">
                                        <el-button type="primary" @click="showPanel3 = false">确认</el-button>
                                        <el-button @click="showPanel3 = false">取消</el-button>
                                      </span>
                                </template>
                            </el-dialog>
                        </el-form-item>
                    ...
                    <el-col :span="12">
                        <el-form-item label="C" prop="optionC">
                            <el-input v-model="formData.optionC" @click="showPanel4=true"/>
                            <el-dialog  v-model="showPanel4" >
                                <v-md-editor  height="300px" v-model="formData.optionC" />
                                <template #footer>
                                      <span class="dialog-footer">
                                        <el-button type="primary" @click="showPanel4 = false">确认</el-button>
                                        <el-button @click="showPanel4 = false">取消</el-button>
                                      </span>
                                </template>
                            </el-dialog>
                        </el-form-item>
                    ...
                    <el-col :span="12">
                        <el-form-item label="D" prop="optionD">
                            <el-input v-model="formData.optionD" @click="showPanel5=true"/>
                            <el-dialog  v-model="showPanel5" >
                                <v-md-editor  height="300px" v-model="formData.optionD" />
                                <template #footer>
                                      <span class="dialog-footer">
                                        <el-button type="primary" @click="showPanel5 = false">确认</el-button>
                                        <el-button @click="showPanel5 = false">取消</el-button>
                                      </span>
                                </template>
                            </el-dialog>
                        </el-form-item>
            ...
            <el-form-item label="标准答案" prop="answer">
                <el-radio-group v-model="formData.answer">
                    ...
                    <el-radio :label="formData.optionC">C</el-radio>
                    <el-radio :label="formData.optionD">D</el-radio>
                </el-radio-group>
            </el-form-item>
            ...
            <el-dialog  v-model="previewPanel" >
                ...
                <div style="display: flex; align-items: center;">
                    <label style="margin-right: 20px">A.{{formData.optionA}}</label>
                    <label style="margin-right: 20px">B.{{formData.optionB}}</label>
                    <label style="margin-right: 20px">C.{{formData.optionC}}</label>
                    <label style="margin-right: 20px">D.{{formData.optionD}}</label>
                </div>
            </el-dialog>
